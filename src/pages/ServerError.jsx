            ...
            <div className="max-w-3xl w-full text-center">
                ...
                <div className="relative mb-12">
                    <div className="absolute inset-0 flex items-center justify-center opacity-[0.03] pointer-events-none select-none">
                        <span className="font-heading text-[15rem] md:text-[20rem] font-black text-red-900">500</span>
                    </div>
                    <div className="relative z-10">
                        ...
                        <h1 className="font-heading text-4xl md:text-7xl font-bold text-slate-900 tracking-tight">
                            Something went <span className="font-heading text-red-500 italic font-medium">wrong.</span>
                        </h1>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
                    <button 
                        onClick={handleRetry}
                        className="font-heading group w-full sm:w-auto px-10 py-4 md:py-5 bg-red-600 text-white rounded-2xl font-bold shadow-xl shadow-red-600/10 hover:shadow-2xl hover:shadow-red-600/20 hover:-translate-y-1 transition-all flex items-center justify-center gap-3"
                    >
                ...
                <div className="max-w-2xl mx-auto p-8 bg-white rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-900/5">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h3 className="font-heading text-xl font-bold text-slate-900">Technical Support</h3>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                        <a href="mailto:support@msit.in" className="flex items-start gap-4 p-4 rounded-2xl hover:bg-slate-50 transition-colors group">
                            ...
                            <div>
                                ...
                                <p className="font-heading font-bold text-slate-900">support@msit.in</p>
                            </div>
                        </a>
                        ...
                        <a href="tel:+919667344125" className="flex items-start gap-4 p-4 rounded-2xl hover:bg-slate-50 transition-colors group">
                            ...
                            <div>
                                <p className="font-body text-sm text-slate-500">Call support</p>
                                <p className="font-heading font-bold text-slate-900">+91 9667344125</p>
                            </div>
                        </a>
                    </div>
                </div>
