import { Code, Server, Shield, Database, Monitor, Cpu, Terminal, ArrowRight, BookOpen, Target, CheckCircle2, FileText, Calendar } from 'lucide-react';
    ...
    return (
        <main className="min-h-screen bg-white">
            ...
            <PageHero 
                ...
                description="Imparting world-class education since 2001 to prepare future software engineers for the rapidly evolving technological landscape (NBA Accredited)."
                breadcrumbs={[{ label: 'Departments' }, { label: 'Computer Science' }]}
            />
            ...
            <section className="py-8 bg-slate-100 border-b border-slate-200">
                <div className="max-w-7xl mx-auto px-6 flex flex-wrap items-center justify-center gap-6 md:gap-12">
                    <span className="font-heading text-slate-500 text-xs font-bold uppercase tracking-widest">Quick Resources:</span>
                    <Link to="/syllabus" className="font-heading flex items-center gap-2 text-sm font-semibold text-slate-700 hover:text-blue-600 transition-colors">
                        <FileText className="w-4 h-4 text-blue-600" /> CSE Syllabus
                    </Link>
                    <Link to="/academic-calendar" className="font-heading flex items-center gap-2 text-sm font-semibold text-slate-700 hover:text-blue-600 transition-colors">
                        <Calendar className="w-4 h-4 text-emerald-600" /> Academic Calendar
                    </Link>
                    <Link to="/placements" className="font-heading flex items-center gap-2 text-sm font-semibold text-slate-700 hover:text-blue-600 transition-colors">
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                        ...
                        <div className="bg-slate-50 p-10 rounded-3xl border border-slate-100 hover:shadow-xl transition-shadow relative overflow-hidden group">
                            ...
                            <ul className="font-body space-y-4 text-slate-600 text-lg">
                                <li className="flex items-start gap-3">
                                    <span className="font-heading font-bold text-emerald-600 mt-1">M1:</span>
                                ...
                                <li className="flex items-start gap-3">
                                    <span className="font-heading font-bold text-emerald-600 mt-1">M2:</span>
            ...
            <section className="py-24 bg-slate-900 text-white">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        <span className="font-heading text-blue-400 font-bold tracking-widest text-sm uppercase mb-4 block">PEOs</span>
                        <h2 className="font-heading text-4xl font-bold tracking-tight mb-6">Program Educational Objectives</h2>
                        <p className="font-body text-slate-400 text-lg">The core goals we strive to achieve for every graduate of the Computer Science program.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={i} className="bg-slate-800/50 backdrop-blur-md p-8 rounded-2xl border border-white/5 hover:bg-slate-800 transition-colors">
                                <div className="font-heading text-blue-400 font-bold text-xl mb-4">{peo.id}</div>
                                <h3 className="font-heading text-2xl font-semibold mb-4 text-white">{peo.title}</h3>
                                <p className="font-body text-slate-400 leading-relaxed">{peo.desc}</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section className="py-24 bg-slate-50">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="mb-16">
                        <span className="font-heading text-blue-600 font-bold tracking-widest text-sm uppercase mb-4 block">Infrastructure</span>
                        <h2 className="font-heading text-4xl md:text-5xl font-bold text-slate-900 tracking-tight">State-of-the-Art <span className="font-bold">Laboratories</span></h2>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        ...
                        <div className="bg-white p-10 rounded-3xl border border-slate-200 shadow-sm lg:row-span-2">
                            ...
                            <h3 className="font-heading text-2xl font-semibold text-slate-900 mb-6">Department Computing Hub</h3>
                            ...
                            <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                                <h4 className="font-heading font-semibold text-slate-900 mb-4">Standard Hardware Specs</h4>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow group flex gap-6">
                                ...
                                <div>
                                    <h4 className="font-heading text-xl font-semibold text-slate-900 mb-2">CN Lab / Python Lab (#105)</h4>
                                    ...
                                    <div className="flex gap-2">
                                        <span className="font-heading px-2 py-1 bg-slate-100 text-slate-600 text-xs font-semibold uppercase rounded tracking-wider">Python</span>
                                        <span className="font-heading px-2 py-1 bg-slate-100 text-slate-600 text-xs font-semibold uppercase rounded tracking-wider">Cisco</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow group flex gap-6">
                                ...
                                <div>
                                    <h4 className="font-heading text-xl font-semibold text-slate-900 mb-2">OS Lab / SSM & DA Lab (#05)</h4>
                                    <p className="font-body text-slate-600 text-sm leading-relaxed mb-4">
                                    ...
                                    <div className="flex gap-2">
                                        <span className="font-heading px-2 py-1 bg-slate-100 text-slate-600 text-xs font-semibold uppercase rounded tracking-wider">Linux</span>
                                        <span className="font-heading px-2 py-1 bg-slate-100 text-slate-600 text-xs font-semibold uppercase rounded tracking-wider">Databases</span>
                                    </div>
                                </div>
                            </div>
                        </div>
