                    ...
                    <div className="p-8 md:p-12 space-y-10 prose prose-slate dark:prose-invert max-w-none">
                        <section>
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4 flex items-center">
                                <BookOpen className="w-6 h-6 mr-3 text-indigo-600 dark:text-indigo-400" /> 1. Acceptance of Terms
                            </h2>
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4 flex items-center">
                                <FileText className="w-6 h-6 mr-3 text-indigo-600 dark:text-indigo-400" /> 2. Intellectual Property
                            </h2>
                            <p className="text-slate-600 dark:text-slate-300 leading-relaxed font-light">
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4 flex items-center">
                                <AlertCircle className="w-6 h-6 mr-3 text-indigo-600 dark:text-indigo-400" /> 3. Code of Conduct
                            </h2>
                            <p className="text-slate-600 dark:text-slate-300 leading-relaxed font-light mb-4">
                            ...
                            <ul className="list-disc pl-6 space-y-2 text-slate-600 dark:text-slate-300 font-light">
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4 flex items-center">
                                <Scale className="w-6 h-6 mr-3 text-indigo-600 dark:text-indigo-400" /> 4. Disclaimers & Limitations
                            </h2>
                            <p className="text-slate-600 dark:text-slate-300 leading-relaxed font-light">
                        ...
                        <section className="bg-indigo-50 dark:bg-indigo-950/30 p-8 rounded-2xl border border-indigo-100 dark:border-indigo-900/40">
                            <h2 className="text-xl font-bold text-indigo-900 dark:text-indigo-200 mb-2">5. Governing Law</h2>
                            <p className="text-indigo-900 dark:text-indigo-300 text-base font-medium">
                                These Terms of Use are governed by the laws of India and are subject to the exclusive jurisdiction of the courts in <strong className="text-indigo-950 dark:text-white">New Delhi</strong>.
                            </p>
                        </section>
                </div>
            </div>
