export const pagesData = {
    ...
    "scholarships": {
        ...
        content: `
            ...
            <p className="mb-6">From government-mandated fee waivers for economically weaker sections (EWS) to prestigious society-sponsored awards for university toppers, our financial aid office is dedicated to helping you fund your education.</p>
        `,
        stats: [
    ...
    "posh": {
        ...
        content: `
            ...
            <p className="mb-6">The committee is empowered to investigate any complaints thoroughly and confidentially, ensuring gender equity and a respectful academic atmosphere for all female students and staff.</p>
        `,
        stats: [
            { label: "Confidentiality", value: "100%" },
            { label: "External NGO Member", value: "Included" }
        ],
        bulletPoints: ["POSH Act Guidelines", "Lodge a Complaint", "Committee Members"]
    },
    "disaster": {
        ...
        content: `
            ...
            <p className="mb-6">The campus is equipped with highly responsive fire alarm systems, strategically placed extinguishers, and clearly marked evacuation routes to handle any unforeseen emergencies efficiently.</p>
        `,
        stats: [
    ...
    "discipline": {
        ...
        content: `
            ...
            <p className="mb-6">We expect our students to exhibit professional behavior, respect for institutional property, and adherence to attendance requirements, preparing them for the strict environments of the corporate world.</p>
        `,
        stats: [
    ...
    "placements": {
        ...
        content: `
            ...
            <h3 className="text-2xl font-semibold text-slate-900 mt-10 mb-4">Industry Readiness</h3>
    ...
    "internship-cell": {
        ...
        content: `
            ...
            <h3 className="text-2xl font-semibold text-slate-900 mt-10 mb-4">Real World Experience</h3>
            <p className="mb-6">Students gain invaluable insights into corporate workflows, agile development methodologies, and production-level codebases, often resulting in direct Pre-Placement Offers (PPOs).</p>
        `,
        stats: [
            { label: "Internships Secured", value: "500+" },
            { label: "Avg Stipend", value: "₹40k/mo" }
        ],
        bulletPoints: ["Ongoing Internship Drives", "PPO Conversion Rate", "NOC Guidelines"]
    },
    ...
    "society-ieee": {
        ...
        content: `
            <div class="space-y-16">
                ...
                <section>
                    <p class="text-lg text-slate-600 mb-8 leading-relaxed">
                        Established in 2009, <strong>IEEE MSIT</strong> is a prominent student branch of IEEE, aimed at advancing the technical skills, career prospects, and professional network of MSIT students. The branch provides numerous opportunities for undergraduates to enhance their practical knowledge and skills in various technical domains.
                    </p>
                </section>
                ...
                <!-- SIGs -->
                <section>
                    <h3 class="text-2xl font-bold text-slate-900 border-l-4 border-indigo-600 pl-4 mb-8">Special Interest Groups (SIGs)</h3>
                    <div class="flex flex-wrap gap-3">
                        <span class="px-4 py-2 bg-indigo-50 text-indigo-700 rounded-full text-sm font-semibold border border-indigo-100">Cloud Computing (AWS/ELB)</span>
                        <span class="px-4 py-2 bg-indigo-50 text-indigo-700 rounded-full text-sm font-semibold border border-indigo-100">DSA & Problem Solving</span>
                        <span class="px-4 py-2 bg-indigo-50 text-indigo-700 rounded-full text-sm font-semibold border border-indigo-100">Placement Preparation</span>
                        <span class="px-4 py-2 bg-indigo-50 text-indigo-700 rounded-full text-sm font-semibold border border-indigo-100">Python & Data Science</span>
                        <span class="px-4 py-2 bg-indigo-50 text-indigo-700 rounded-full text-sm font-semibold border border-indigo-100">Prototyping & Soldering</span>
                        <span class="px-4 py-2 bg-indigo-50 text-indigo-700 rounded-full text-sm font-semibold border border-indigo-100">GSoC Mentorship</span>
                        <span class="px-4 py-2 bg-indigo-50 text-indigo-700 rounded-full text-sm font-semibold border border-indigo-100">Internet of Things (IoT)</span>
                    </div>
                </section>

                <!-- Activities -->
                <section>
                    <h3 class="text-2xl font-bold text-slate-900 border-l-4 border-blue-600 pl-4 mb-8">Major Activities</h3>
                    <div class="space-y-6">
                        <div class="flex gap-4">
                            ...
                            <div>
                                <h4 class="font-bold text-slate-900">Workshops & Hackathons</h4>
                                <p class="text-sm text-slate-600 leading-relaxed">Regular sessions on Android/Web dev, Robotics, and AR to bridge the academic-industry gap.</p>
                            </div>
                        </div>
                        <div class="flex gap-4">
                            <div class="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center shrink-0">
                            ...
                            <div>
                                <h4 class="font-bold text-slate-900">Annual Tech Fest - AVENSIS</h4>
                                <p class="text-sm text-slate-600 leading-relaxed">Members play critical roles in organizing the flagship tech-fest, featuring coding marathons and innovation showcases.</p>
                            </div>
                        </div>
                        <div class="flex gap-4">
                            <div class="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center shrink-0">
                            ...
                            <div>
                                <h4 class="font-bold text-slate-900">IEEE Day Celebrations</h4>
                                <p class="text-sm text-slate-600 leading-relaxed">Yearly celebrations featuring talks from industry leaders, alumni, and veteran researchers.</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <!-- Achievements -->
                <section>
                    <h3 class="text-2xl font-bold text-slate-900 border-l-4 border-emerald-600 pl-4 mb-8">International & Regional Recognition</h3>
                    <div class="space-y-4 text-sm text-slate-600">
                        <div class="p-4 bg-emerald-50 border border-emerald-100 rounded-xl">
                            <strong>Outstanding Student Branch Award 2023</strong>: Ranked as the top branch in the Asia Pacific (R10) region.
                        </div>
                        <div class="p-4 bg-emerald-50 border border-emerald-100 rounded-xl">
                            <strong>PES R10 Excellence</strong>: Ranked #17 in the Asia-Pacific region and #1 in the Delhi Section.
                        </div>
                        <div class="p-4 bg-emerald-50 border border-emerald-100 rounded-xl">
                            <strong>Darrel Chong Award</strong>: Received consistently in 2023 and 2024 for impact-driven student activities.
                        </div>
                    </div>
                </section>
                ...
                <!-- Leadership -->
                <section>
                    <h3 class="text-2xl font-bold text-slate-900 border-l-4 border-slate-900 pl-4 mb-8">Leadership Team</h3>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="text-center">
                            <div class="text-sm font-bold text-slate-900">Dr. Anupama Kaushik</div>
                            <div class="text-xs text-slate-500">Branch Counselor</div>
                        </div>
                        <div class="text-center">
                            <div class="text-sm font-bold text-slate-900">Shaurya Mishra</div>
                            <div class="text-xs text-slate-500">Chairperson</div>
                        </div>
                        <div class="text-center">
                            <div class="text-sm font-bold text-slate-900">Ishika Garg</div>
                            <div class="text-xs text-slate-500">Vice Chairperson</div>
                        </div>
                    </div>
                </section>
                ...
                <section class="pt-8 border-t border-slate-100">
                    <div class="flex flex-wrap justify-center gap-6">
                        <a href="https://www.instagram.com/ieeemsit" target="_blank" class="flex items-center text-slate-400 hover:text-pink-600 transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mr-2"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
                            Instagram
                        </a>
                        <a href="https://www.linkedin.com/company/ieeemsit" target="_blank" class="flex items-center text-slate-400 hover:text-blue-700 transition-colors">
                        ...
                        <a href="https://www.facebook.com/ieeemsit" target="_blank" class="flex items-center text-slate-400 hover:text-blue-600 transition-colors">
                        ...
                        <a href="https://www.youtube.com/@ieeemsit8720" target="_blank" class="flex items-center text-slate-400 hover:text-red-600 transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mr-2"><path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-1.94C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 1.94C1 8.14 1 12 1 12s0 3.86.46 5.58a2.78 2.78 0 0 0 1.94 1.94c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 0 0 1.94-1.94C23 15.86 23 12 23 12s0-3.86-.46-5.58z"></path><polygon points="9.75 15.02 15.5 12 9.75 8.98 9.75 15.02"></polygon></svg>
                            YouTube
                        </a>
                        <a href="https://x.com/ieeemsit" target="_blank" class="flex items-center text-slate-400 hover:text-slate-900 transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mr-2"><path d="M4 4l11.733 16h4.267l-11.733 -16z"></path><path d="M4 20l6.768 -6.768m2.46 -2.46l6.772 -6.772"></path></svg>
                            Twitter (X)
                        </a>
                    </div>
                </section>
