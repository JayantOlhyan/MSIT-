            ...
            <div class="space-y-16">
                ...
                <section class="pt-8 border-t border-slate-100">
                    <div class="flex justify-center gap-6">
                        <a href="https://www.instagram.com/ieeemsit" target="_blank" class="text-slate-400 hover:text-pink-600 transition-colors">Instagram</a>
                        <a href="https://www.linkedin.com/company/ieeemsit" target="_blank" class="text-slate-400 hover:text-blue-700 transition-colors">LinkedIn</a>
                        <a href="https://www.facebook.com/ieeemsit" target="_blank" class="text-slate-400 hover:text-blue-600 transition-colors">Facebook</a>
                        <a href="https://www.youtube.com/@ieeemsit8720" target="_blank" class="text-slate-400 hover:text-red-600 transition-colors">YouTube</a>
                    </div>
                </section>
            </div>
        `,
